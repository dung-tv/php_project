...
class CreateTablesShop extends Migration
{
    ...
    public function up()
    {
        ...
        //add cart
        Schema::create(SC_DB_PREFIX.'shop_user_cart', function(Blueprint $table) {
            ...
            $table->primary(['id_user', 'product_id', 'options', 'instance']);
        });

        //add comment
        Schema::create(SC_DB_PREFIX.'shop_user_comment', function(Blueprint $table) {
            $table->integer('id_user');
            $table->integer('product_id');
            $table->text('comment');
            $table->primary(['id_user', 'product_id']);
        });
        //add rate
        Schema::create(SC_DB_PREFIX.'shop_user_rate', function(Blueprint $table) {
            $table->integer('id_user');
            $table->integer('product_id');
            $table->integer('rate_qty');
            $table->index(['id_user', 'product_id']);
        });
    ...
    public function down()
    {
        ...
        //add cart
        Schema::dropIfExists(SC_DB_PREFIX.'shop_user_cart');
        //add comment
        Schema::dropIfExists(SC_DB_PREFIX.'shop_user_comment');
        //add rate
        Schema::dropIfExists(SC_DB_PREFIX.'shop_user_rate');
        //
