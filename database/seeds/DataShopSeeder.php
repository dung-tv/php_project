...
<script>
  ...
  gtag(\'config\', \'UA-128658138-1\');
        ...
        DB::table(SC_DB_PREFIX.'shop_product_promotion')->insert([
            ['product_id' => '1', 'price_promotion' => '5000', 'date_start' => now('Asia/Ho_Chi_Minh')->addDays(-2)->toDateString(), 'date_end' => now('Asia/Ho_Chi_Minh')->addDays(3)->toDateString()],
            ['product_id' => '2', 'price_promotion' => '3000', 'date_start' => now('Asia/Ho_Chi_Minh')->addDays(-2)->toDateString(), 'date_end' => now('Asia/Ho_Chi_Minh')->addDays(3)->toDateString()],
            ['product_id' => '13', 'price_promotion' => '4000', 'date_start' => now('Asia/Ho_Chi_Minh')->addDays(-2)->toDateString(), 'date_end' => now('Asia/Ho_Chi_Minh')->addDays(3)->toDateString()],
            ['product_id' => '11', 'price_promotion' => '600', 'date_start' => now('Asia/Ho_Chi_Minh')->addDays(-2)->toDateString(), 'date_end' => now('Asia/Ho_Chi_Minh')->addDays(3)->toDateString()],
        ]);
