...
<div class="row">
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v8.0&appId=2795729107324348&autoLogAppEvents=1" nonce="4EWnp9qv"></script>
    <div class="fb-comments" data-href="{{ $product->getUrl() }}" data-numposts="10" data-width="100%"></div>
</div>
